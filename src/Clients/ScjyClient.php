...
class ScjyClient extends BaseClient
{
    ...
    public function getInvestorInfo(array $params)
    {
        ...
        return $this->request('/v2/scjy/data/getInvestorInfo', $params);
    }
    ...
    public function getEnterpriseAndInvestorInfo(array $params)
    {
        ...
        return $this->request('/v2/scjy/basic/getEnterpriseAndInvestorInfo', $params);
    }
    ...
    public function getRevenueExpenseAndPrepaymentInfo(array $params)
    {
        ...
        return $this->request('/v2/scjy/calculateTax/getRevenueExpenseAndPrepaymentInfo', $params);
    }
    ...
    public function calculateASynIndividualIncomeTax(array $params)
    {
        ...
        return $this->request('/v2/scjy/calculateTax/calculateASynIndividualIncomeTax', $params);
    }
    ...
    public function getASynIndividualIncomeTaxFeedback(array $params)
    {
        ...
        return $this->request('/v2/scjy/calculateTax/getASynIndividualIncomeTaxFeedback', $params);
    }
    ...
    public function sendDeclaration(array $params)
    {
        ...
        return $this->request('/v2/scjy/report/send', $params);
    }
    ...
    public function getDeclarationFeedback(array $params)
    {
        ...
        return $this->request('/v2/scjy/report/getFeedback', $params);
    }
    ...
    public function getDeclareTaxResultFeedback(array $params)
    {
        ...
        return $this->request('/v2/scjy/report/getDeclareTaxResultFeedback', $params);
    }
    ...
    public function getCompanyIncomes(array $params)
    {
        ...
        return $this->request('/v2/scjy/report/getCompanyIncomes', $params);
    }
    ...
    public function checkDeclarationStatus(array $params)
    {
        ...
        return $this->request('/v2/scjy/report/checkStatus', $params);
    }
    ...
    public function abandonedDeclaration(array $params)
    {
        ...
        return $this->request('/v2/scjy/report/abandoned', $params);
    }
    ...
    public function getAbandonedFeedback(array $params)
    {
        ...
        return $this->request('/v2/scjy/report/abandonedFeedback', $params);
    }
    ...
    public function correctDeclaration(array $params)
    {
        ...
        return $this->request('/v2/scjy/report/correct', $params);
    }
    ...
    public function cancelCorrectDeclaration(array $params)
    {
        ...
        return $this->request('/v2/scjy/report/cancelCorrect', $params);
    }
    ...
    public function getThirdInfo(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/thirdInfo', $params);
    }
    ...
    public function getThirdInfoFeedback(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/thirdInfo/feedback', $params);
    }
    ...
    public function thirdAgreementPayment(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/thirdAgreementPayment', $params);
    }
    ...
    public function getThirdAgreementPaymentFeedback(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/thirdAgreementPayment/feedback', $params);
    }
    ...
    public function getUnionPayUrl(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/getUnionPayUrl', $params);
    }
    ...
    public function scanPayment(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/scanPay', $params);
    }
    ...
    public function checkPaymentStatus(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/checkStatus', $params);
    }
    ...
    public function printWithholdingVoucher(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/withholdingVoucher', $params);
    }
    ...
    public function getWithholdingVoucherFeedback(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/getWithholdingVoucherFeedback', $params);
    }
    ...
    public function checkPaymentReceipt(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/checkReceipt', $params);
    }
    ...
    public function cancelWithholdingVoucher(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/cancelWithholdingVoucher', $params);
    }
    ...
    public function getWithheldVoucher(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/getWithheldVoucher', $params);
    }
    ...
    public function queryArrearage(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/queryArrearage', $params);
    }
    ...
    public function getArrearageQueryFeedback(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/getArrearageQueryFeedback', $params);
    }
    ...
    public function lbljCheck(array $params)
    {
        ...
        return $this->request('/v2/scjy/check/lbljCheck', $params);
    }
    ...
    public function queryTaxPayment(array $params)
    {
        ...
        return $this->request('/v2/scjy/payment/queryTaxPayment', $params);
    }
}
