...
class RiskClient extends BaseClient
{
    ...
    public function standard(array $params)
    {
        ...
        return $this->request('/v2/risk/hmd/standard', $params);
    }
    ...
    public function qyfkmx(array $params)
    {
        ...
        return $this->request('/v2/risk/hmd/qyfkmx', $params);
    }
    ...
    public function jyyc(array $params)
    {
        ...
        return $this->request('/v2/risk/hmd/jyyc', $params);
    }
    ...
    public function yzwf(array $params)
    {
        ...
        return $this->request('/v2/risk/hmd/yzwf', $params);
    }
    ...
    public function zdsswf(array $params)
    {
        ...
        return $this->request('/v2/risk/hmd/zdsswf', $params);
    }
    ...
    public function fzchnew(array $params)
    {
        ...
        return $this->request('/v2/risk/hmd/fzchnew', $params);
    }
    ...
    public function plus(array $params)
    {
        ...
        return $this->request('/v2/risk/hmd/plus', $params);
    }
    ...
    public function qycx(array $params)
    {
        ...
        return $this->request('/v2/risk/hmd/qycx', $params);
    }
    ...
    public function qycxnew(array $params)
    {
        ...
        return $this->request('/v2/risk/hmd/qycxnew', $params);
    }
}
