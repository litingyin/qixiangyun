...
class SpxxClient extends BaseClient
{
    ...
    public function queryTaxInfoByCode(array $params)
    {
        ...
        return $this->requestBaseResponse('/v2/invoice/qdfp/spxxFmxx', $params);
    }
    ...
    public function addCategory(array $params)
    {
        ...
        return $this->requestBaseResponse('/v2/invoice/qdfp/spxxFladd', $params);
    }
    ...
    public function deleteCategory(array $params)
    {
        ...
        return $this->requestBaseResponse('/v2/invoice/qdfp/spxxFldel', $params);
    }
    ...
    public function updateCategory(array $params)
    {
        ...
        return $this->requestBaseResponse('/v2/invoice/qdfp/spxxFlrename', $params);
    }
    ...
    {
        return $this->requestBaseResponse('/v2/invoice/qdfp/spxxCx', $params);
    }
    ...
    public function addProduct(array $params)
    {
        ...
        return $this->requestBaseResponse('/v2/invoice/qdfp/spxxAdd', $params);
    }
    ...
    public function updateProduct(array $params)
    {
        ...
        return $this->requestBaseResponse('/v2/invoice/qdfp/spxxUpdate', $params);
    }
    ...
    public function deleteProduct(array $params)
    {
        ...
        return $this->requestBaseResponse('/v2/invoice/qdfp/spxxDel', $params);
    }
}
